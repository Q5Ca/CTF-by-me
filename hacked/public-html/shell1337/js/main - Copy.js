...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "flag.txt": "BKSec{robots.txt_is_S0_interesting}"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
...
var main = (function () {
    ...
    Terminal.prototype.type = function (text, callback, sk = 1) {
        this.typeSimulator.type(text, callback, sk);
    };
    ...
    Terminal.prototype.reboot = function () {
        this.type(configs.getInstance().reboot_message, this.reset.bind(this), 0);
    };
    ...
    TypeSimulator.prototype.type = function (text, callback, sk) {
        if (isURL(text)) {
            window.open(text);
        }
        var i = 0;
